...
-- -----------------------------------------------------
-- Table `OCPizza`.`EmployeeHasOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OCPizza`.`EmployeeHasOrder` (
  `Employee_employee_id` INT NOT NULL,
  `Order_order_id` INT NOT NULL,
  PRIMARY KEY (`Employee_employee_id`, `Order_order_id`),
  INDEX `fk_Employee_has_Order_Order1_idx` (`Order_order_id` ASC) VISIBLE,
  INDEX `fk_Employee_has_Order_Employee1_idx` (`Employee_employee_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `OCPizza`.`CustomerHasOrder`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OCPizza`.`CustomerHasOrder` (
  `Customer_customer_id` INT NOT NULL,
  `Order_order_id` INT NOT NULL,
  PRIMARY KEY (`Customer_customer_id`, `Order_order_id`),
  INDEX `fk_Customer_has_Order_Order1_idx` (`Order_order_id` ASC) VISIBLE,
  INDEX `fk_Customer_has_Order_Customer1_idx` (`Customer_customer_id` ASC) VISIBLE,
  CONSTRAINT `fk_Customer_has_Order_Customer1`
    FOREIGN KEY (`Customer_customer_id`)
    REFERENCES `OCPizza`.`Customer` (`customer_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
